...
export function TokenUsage() {
  ...
  return (
    <div className="flex items-center gap-3 px-3 py-1.5 rounded-md border border-bolt-elements-borderColor bg-bolt-elements-background-depth-1 text-xs text-bolt-elements-textSecondary" title={`Total: ${usage.totalTokens.toLocaleString()} / ${CONTEXT_LIMIT.toLocaleString()}`}>
